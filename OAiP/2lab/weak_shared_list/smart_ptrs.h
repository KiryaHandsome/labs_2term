...
public:
	...
	shared_ptr() : c_ptr() //default constructor
	{
	}
...
public:
	...
	shared_ptr() : c_ptr(new ControlBlock<T>) //default constructor
	{
	}
...
private:
	...
	ControlBlock<T>* c_ptr = nullptr;
public:
	weak_ptr() : c_ptr(new ControlBlock<T>)
	{
	}
